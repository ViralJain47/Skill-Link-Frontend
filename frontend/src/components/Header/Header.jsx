  ...
  return (
    <header className="w-full py-4 px-6 md:px-12 lg:px-24 flex items-center justify-between border-b border-b-neutral-400 fixed top-0 left-0 bg-transparent/10 backdrop-blur-md p-4 z-50">
      ...
      <div className="flex items-center gap-4">
        <Link
          to="/login"
          className="text-sm font-medium hover:border-black border border-transparent px-4 py-2 rounded-xl duration-200"
        >
          Log In
        </Link>
        <Link to="/register">
          <Button className="bg-amber-500 border hover:bg-amber-600 text-black font-normal rounded-xl px-1.5-2.5">
            Register
          </Button>
        </Link>
      </div>
