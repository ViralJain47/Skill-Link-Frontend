  ...
  return (
    <div className='w-full flex justify-center items-center px-20 py-40 gap-20'>
      <div className='flex-col justify-center items-start'>
        ...
        <a href='mailto:support.skilllink@gmail.com' className='flex border hover:scale-105 duration-300 justify-around items-center px-7 py-5 mt-15 bg-amber-500 rounded-2xl gap-5'>
      ...
      <div className='w-1/2'>
        <form className='flex flex-col w-full justify-center items-center gap-7'>
          ...
          <div className='w-full flex flex-col gap-2'>
            <label className='text-xl font-semibold' htmlFor="">Your message</label>
            <textarea className='mt-1 border px-4 py-2 rounded-md border-gray-300' placeholder='Message goes here...' />
